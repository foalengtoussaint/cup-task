"""Tests for pipeline.cloud_velocity, on synthetic cameras with a KNOWN ground-truth motion.
...
from pipeline.cloud_velocity import (                       # noqa: E402
...
def test_umeyama_recovers_scale_and_kabsch_does_not():
    ...
    """
    from pipeline.cloud_velocity import umeyama
    P = object_points()
