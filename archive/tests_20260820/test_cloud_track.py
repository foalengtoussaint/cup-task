"""Tests for pipeline.cloud_track -- the tracked-cloud (correspondence-by-construction) pipeline.
...
from pipeline.cloud_track import CloudTracker, surface_seed, _visible   # noqa: E402
