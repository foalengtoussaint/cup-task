...
and a head-distance feature channel.
    ...
    python -m pipeline.pipeline CLIPDIR --calib calib.toml --stem P07_drinking_right_...
...
from pipeline import cup_detect, pose_keypoints, pose_smooth, segment, triangulate
...
def wrist_speed_v3(json_dir: Path, tracks: dict, calib: Path, wrist: str,
    ...
    from pipeline import speed_blend
    from pipeline.kalman_3d import load_calibration
