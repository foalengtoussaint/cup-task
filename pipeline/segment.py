...
def segment_cup_only(xyz, fps=FPS, *, fwd_on=FWD_ON, back_off=BACK_OFF,
    ...
    # a sign change, not a magnitude. See archive/docs_20260820/older/PIPELINE_V3.md.
    ...
    # in that signal. (Two attempts to do so are recorded in archive/docs_20260820/older/PIPELINE_V3.md.)
    #
