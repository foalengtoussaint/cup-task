...
Per-trial OBSERVATIONAL table (no augmentation yet) joining, for every cohort trial:
  ...
  OUTCOMES
    ...
    measure error: |mmc - automq| per Murphy measure (out/automq/score_vs_automq.csv, BA+smoothnet)
...
SCORE = Path(os.environ.get("SCORE_CSV", REPO / "out/automq/score_vs_automq.csv"))
OUT = REPO / "paper"
