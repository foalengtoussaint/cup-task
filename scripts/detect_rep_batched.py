...
from cup_task.cup_detect import CUP_CLASS, MIN_CONF, CupDet, to_payload as cup_payload
from cup_task.pose_keypoints import (KP_INDEX, MIN_KP_CONF, TASK_KP, FramePose,
