...
pipeline.score.compute_position_measures -- the position-derived subset cup-task ports (the
...
def main(argv=None):
    ...
    if a.hybrid2:
        ...
        from pipeline.score import _smoothed_xyz as _sm
    ...
    # Segment EXACTLY as pipeline/pipeline.py:phases_from_3d does -- the segmenter we already
